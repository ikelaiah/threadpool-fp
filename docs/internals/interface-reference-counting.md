...
1. Be aware of implicit interface conversions - When passing an object to a method expecting an interface - When assigning an object to an interface variable
