...
[Simple API](../reference/simple-api.md) or
[Producer-Consumer API](../reference/producer-consumer-api.md). Task handles,
...
- [Choose a Pool](choosing-a-pool.md)
- [Beginner Guide](beginner-guide.md)
- [Examples guide](../../examples/README.md)
- [Help with v0.9.1 release notes](../history/release-notes-v0.9.1.md)
