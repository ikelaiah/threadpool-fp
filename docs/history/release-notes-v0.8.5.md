...
- The new [`CHEATSHEET.md`](../getting-started/cheat-sheet.md) collects the calls and safety rules
...
| Recall a call or safety rule | [Cheat sheet](../getting-started/cheat-sheet.md) |
| Explore every public member | [Simple API](../reference/simple-api.md) or [Producer-Consumer API](../reference/producer-consumer-api.md) |
| Understand internals | [Simple technical guide](../internals/simple-internals.md) or [Producer-Consumer technical guide](../internals/producer-consumer-internals.md) |
